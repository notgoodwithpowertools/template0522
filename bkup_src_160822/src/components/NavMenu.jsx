...
const NavMenu = ({ onLogout }) => {
  ...
  return (
    ...
    <nav>
      <div className='nav'>
        <ul className='nav_ul'>
          <li className='nav_li'><NavLink to="/" style={({isActive}) => getActiveState(isActive)}><Image src={user_img} height={25} width={25} /><div className='nav_text'>Home</div></NavLink></li>
          <li className='nav_li'><NavLink to="/user" style={({isActive}) => getActiveState(isActive)}><Image src={user_img} height={25} width={25} /><div className='nav_text'>User</div></NavLink></li>
          ...
          <li className='nav_li'><NavLink to="/login" style={({isActive}) => getActiveState(isActive)} onClick={() => onLogout()}><Image src={logout_img} height={25} width={25} /><div className='nav_text'>Logout</div></NavLink></li>
